#!/bin/bash
# A non-interactive docker run wrapper for deployments of the excellent lloesche/valheim-server-docker, with Valheim Plus enabled.
# This is more of an academic/learning thing with scripts.
# By https://github.com/kachunkachunk
# v0.1 - 2021/03/03: Initial authoring/draft
...
# 5) 4am check/installation of updates
...
v_containername="valheim-testkitchen"
v_servername="Lunch Crew Alumni (Testkitchen)"
v_serverpassword=""
v_serverport="2456"
v_serverpublic="1"
v_serverworld="testkitchen"
